using DigiKalaMobileApp.DataAccess.Models;
using System;
...
namespace DigiKalaMobileApp.DataAccess.Services.Repositories
{
    public class SearchMatchRepository
    {
        ...
        public IEnumerable<SearchMatch> GetAll(string searchText = null)
        {
            return string.IsNullOrEmpty(searchText) ? new List<SearchMatch>() : _searchMatches.Where(sm => sm.Text.Contains(searchText));
        }
    }
}